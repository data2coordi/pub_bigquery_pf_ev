...
+---------------+--------+------------+---------+---------------------+
| pf seqid only |     10 |    9500000 | 9500000 | 2023-12-17 02:16:02 |
+---------------+--------+------------+---------+---------------------+
select 
...
from 
`ml_dataset.bigdata_for_ev`
where num_col1 = 18500113; -- at [12:1]
+----------------------+--------+------------+----------+---------------------+
|         f0_          | partid | clusterdid | num_col1 |          t          |
+----------------------+--------+------------+----------+---------------------+
| pf randum colum only |     10 |    9500000 | 18500113 | 2023-12-17 02:16:02 |
+----------------------+--------+------------+----------+---------------------+
+------------------------------+--------------------+----------------------+-----------+
|            query             |    processed_MB    |     Charges_yen      | cache_hit |
+------------------------------+--------------------+----------------------+-----------+
